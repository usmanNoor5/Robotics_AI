...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        # State = (position, tuple of booleans for which corners are visited)
        # Initially no corners are visited
...
class ClosestDotSearchAgent(SearchAgent):
    ...
    def findPathToClosestDot(self, gameState: pacman.GameState):
        ...
        "*** YOUR CODE HERE ***"
        # Use BFS to find the shortest path to the closest food dot
        # AnyFoodSearchProblem defines the goal as "any cell with food"
